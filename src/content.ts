...
export const plans = [
  {
    title: 'Plano Bianual',
    detail: '24 Meses - R$ 2.376,00',
    detailNote: '(Pagamento único na assinatura)',
    price: '99',
    period: '/mês',
    text: 'valor mensal equivalente',
    items: [
      'Endereço Fiscal (Formalização de empresa)',
      'Gestão de Correspondência',
      'Redirecionamento de Correspondências via E-mail',
      '15% de Desconto em Salas de Reunião e Treinamento',
    ],
    cta: 'Contratar agora',
  },
  {
    title: 'Plano Anual',
    detail: '12 Meses - R$ 1.668,00',
    detailNote: '(Pagamento único na assinatura)',
    price: '139',
    period: '/mês',
    text: 'valor mensal equivalente',
  ...
  },
  {
    ...
    detail: 'Pagamento recorrente',
    detailNote: '',
    price: '199',
    period: '/mês',
    text: 'valor fixo mensal',
    items: [
      'Endereço Fiscal (Formalização de empresa)',
      'Gestão de Correspondência',
      'Redirecionamento de Correspondências via E-mail',
